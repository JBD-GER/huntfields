...
values
  (
    ...
    'A polished Southeast season lease for a small approved hunting party. The huntable area includes pine blocks, hardwood drains, food plots, and creek-edge travel corridors. Public visitors see only a general location and rounded ranges; registered users can review richer listing detail, while exact gates, routes, and owner-drawn boundaries stay protected until landowner approval.',
    'US',
    'United States',
    'GA',
    'Georgia',
  ...
  (
    ...
    'A private ranch access lease for hunters who need meaningful acreage, clear operating rules, and a strong approval-first workflow. The huntable block includes draws, senderos, water, grassland edges, and upland quail cover. Exact roads, gates, and detailed boundary geometry remain private until the landowner approves the party and terms.',
    'US',
    'United States',
    'TX',
    'Texas',
  ...
  (
    ...
    'This guided access listing gives hunters a realistic sense of terrain and scale before they request access, while keeping exact owner-drawn routes and boundaries private. The area includes timber benches, meadow edges, glassing points, and seasonal two-track approach routes. Final coordinates, gate instructions, and guide contact details are released only after approval and signature.',
    'US',
    'United States',
    'MT',
    'Montana',
